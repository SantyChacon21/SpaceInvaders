...
public class JuegoController {
	...
	public void agregarPuntuacion (int puntos) {
		JuegoController.puntuacion += puntos;
		
		int vidasGanadasPorPuntos = JuegoController.puntuacion / 500;
	...
	private void gameOver () {
		...
		String nombre = JOptionPane.showInputDialog(null, "Game Over! Ingresá tu nombre para el ranking:");
		if (nombre != null && !nombre.trim().isEmpty()) {
		    Ranking.guardar(nombre, puntuacion);
		}
